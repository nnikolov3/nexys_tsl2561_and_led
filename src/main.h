 ...
 *          Nexys peripherals) and FreeRTOS constructs (tasks, semaphores, queues) 
 *          in a Microblaze-based system. Supports button-driven LED toggling, 
 *          PID control of RGB LED brightness, and sensor reading/display updates.
 *
...
#define N4IO_DEVICE_ID XPAR_NEXYS4IO_0_DEVICE_ID       // Device ID for Nexys4IO peripheral
#define N4IO_BASEADDR  XPAR_NEXYS4IO_0_S00_AXI_BASEADDR // Base address for Nexys4IO AXI interface
#define N4IO_HIGHADDR  XPAR_NEXYS4IO_0_S00_AXI_HIGHADDR // High address for Nexys4IO AXI interface
#define INTC_DEVICE_ID XPAR_INTC_0_DEVICE_ID           // Device ID for AXI interrupt controller
#define I2C_BASE_ADDR  XPAR_AXI_IIC_0_BASEADDR         // Base address for AXI IIC controller
#define I2C_DEV_ID_ADDR XPAR_AXI_IIC_0_DEVICE_ID       // Device ID for AXI IIC controller
#define GPIO_INTR_ID XPAR_MICROBLAZE_0_AXI_INTC_AXI_GPIO_1_IP2INTC_IRPT_INTR // Interrupt ID for GPIO button channel
...
#define MAIN_DONT_BLOCK   ((TickType_t) 0) // Non-blocking operation for queue send/receive

/* Global variables - Extern declarations for objects defined in main.c */
extern XGpio xInputGPIOInstance;     // GPIO instance for buttons and switches, defined in main.c
extern SemaphoreHandle_t binary_sem; // Binary semaphore for signaling button interrupts, defined in main.c
extern QueueHandle_t toPID;          // Queue for sending button/switch states to PID task, defined in main.c
extern QueueHandle_t fromPID;        // Queue for sending setpoint/lux to display task, defined in main.c
extern XIntc Intc;                   // Shared interrupt controller instance, defined in main.c
extern XIic IicInstance;             // I2C instance for TSL2561 communication, defined in i2c.c
 ...
 * Configures GPIO instance, installs interrupt handler, and enables interrupts using FreeRTOS APIs.
 *
 ...
 * Waits for the semaphore, reads GPIO inputs, and sends states to the PID task via queue.
 *
 ...
 * Sets up hardware components without configuring interrupts (done separately in main).
 *
